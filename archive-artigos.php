...
<section class="area-textos fix">
	<div class="container">
			...
			<div class="col-conteudo">
						...
						<article class="post- type-artigos">
						...
						<?php $c++; if( !$paged && $c == 1) :?>
								...
								<header>
									...
									<h1><a href="<?php the_permalink(); ?>"><?php echo get_post_field('post_title', '8511'); ?></a></h1>
								</header>			
								<?php echo wpautop(get_post_field('post_content', '8511')); ?>

								<div class="fix">&nbsp;</div>

								<h3 class="upper">Artigos</h3>
			...
			<div class="col-aside">
				<div class="box">
					<h3>Biblioteca</h3>
					<li class="lista-evento"><a href="<?php bloginfo('url'); ?>/index.php/artigos"><strong>Artigos</strong></a></li>
	...
	<div class="container">
			...
			<div class="col-conteudo full">
						...
						<?php $c++; if( !$paged && $c == 1) :?>
								...
								<p><a href="<?php the_permalink(); ?>" class="btn-block"><span>Ler artigo na integra</span></a></p>

								<div class="fix">&nbsp;</div>

								<h3 class="upper">Ver mais artigos</h3>
