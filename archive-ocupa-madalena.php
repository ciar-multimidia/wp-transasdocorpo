	...
	<div class="container">
			...
			<div class="col-conteudo">
						...
						<article class="post- type-ocupa-madalena">
							...
							<?php $c++; if( !$paged && $c == 1) :?>
								...
								<header>
									<h2><span>Ocupa Madalena</span></h2>
								...
								<h3 class="upper">Mais sobre Ocupa Madalena</h3>
			...
			<div class="col-aside">
				<div class="box">
					...
					<li class="lista-evento"><a href="<?php bloginfo('url'); ?>/index.php/ocupa-madalena"><strong>Sobre nós</strong></a></li>
