	...
	<div class="container">
			...
			<div class="col-conteudo">
						...
						<?php $c++; if( !$paged && $c == 1) :?>
								...
								<header>
									...
									<h1><a href="<?php the_permalink(); ?>"><?php echo get_post_field('post_title', '8513'); ?></a></h1>
								</header>			
								<?php echo wpautop(get_post_field('post_content', '8513')); ?>
			...
			<div class="col-aside">
				<div class="box">
					...
					<li class="lista-evento"><a href="<?php bloginfo('url'); ?>/index.php/informativos"><strong>Informativo Fazendo Gênero</strong></a></li>
				</div>
	...
	<div class="container">
			...
			<div class="col-conteudo full">
						...
						<?php $c++; if( !$paged && $c == 1) :?>
								...
								<p><a href="<?php the_permalink(); ?>" class="btn-block"><span>Ler informativo na integra</span></a></p>

								<div class="fix">&nbsp;</div>

								<h3 class="upper">Ver mais informativos</h3>
