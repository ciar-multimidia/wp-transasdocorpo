	...
	<div class="container">
			...
			<div class="col-conteudo">
						...
						<article class="post- type-ocupa-madalena">
							...
							<?php $c++; if( !$paged && $c == 1) :?>
								...
								<header>
									<h2><span>Ocupa Madalena - Espetáculos</span></h2>
								...
								<h3 class="upper">Outros espetáculos</h3>
			...
			<div class="col-aside">
				<div class="box">
					...
					<li class="lista-evento"><a href="<?php bloginfo('url'); ?>/index.php/ocupa-madalena-esp"><strong>Espetáculos</strong></a></li>
				</div>
